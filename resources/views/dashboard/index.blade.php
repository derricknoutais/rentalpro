                ...
                <div class="overflow-hidden bg-white shadow sm:rounded-lg w-1/2 mr-2">
                    <div class="flex ">
                        <div class="px-4 py-2 sm:px-6">
                            ...
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">Voici ce qui se passe a
                                {{ Auth::user()->compagnie->nom }}</p>
                        </div>
                    </div>
                ...
                <div class="overflow-hidden bg-blue-50 shadow sm:rounded-lg w-1/2 ml-2">
                    <div class="flex justify-between items-center">
                        <div class="px-4 py-2 sm:px-6">
                            ...
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">Toutes les Reservations Vehicules / Chambres /
                                Maintenance</p>
                        </div>
                        <div class="px-4 py-2 sm:px-6">
                            <a href="/reservations" type="button"
