...
@section('content')
    <div class="container-fluid">
        ...
        <div class="flex justify-between px-5 py-10 mt-10 bg-yellow-50">
            <div>
                <button type="button" class="text-white bg-green-500 btn">
                    <i class="fas fa-plus "></i>
                    <span class="ml-3">Ajouter Contrat</span>
                </button>
                <a href="edit" class="ml-5 text-white bg-blue-500 btn">
                    <i class="fas fa-edit "></i>
                    <span class="ml-3">Modifier Informations</span>
                </a>
            </div>
            <div>
                <button type="button" class="ml-5 text-white bg-red-500 btn">
