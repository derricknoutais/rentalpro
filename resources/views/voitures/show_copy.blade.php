<voiture-show inline-template :voiture="{{ $voiture }}">
    <div>
        <!-- En Tête -->
        <h1 class="mt-5 text-4xl text-center">
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="mt-5 row">
                        ...
                        @if($voiture->etat == 'loué')
                            <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#receptionvehicule">
                               <i class="mr-2 fas fa-hands"></i> Réceptionner Véhicule
                            </button>
                        @endif
                        ...
                        @if($voiture->etat == 'maintenance')
                            <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#receptionvehiculemaintenance">
                               <i class="mr-2 fas fa-hands"></i> Réceptionner Véhicule De Maintenance
                            </button>
                        @endif

                        {{-- Voir Pannes --}}
                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#voirPannes"><i class="mr-2 fas fa-exclamation-triangle text-warning"></i> Voir Pannes</button>

                        {{-- Signaler Panne --}}
                        <button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#panneSignalisation"><i class="mr-2 fas fa-exclamation-triangle text-warning"></i> Ajouter une Panne</button>


                        {{-- Envoyer en Maintenance --}}
                        <button type="button" class="btn btn-warning btn-block" @click="toggleMaintenanceModal({{ $voiture }})">
                            <i class="mr-2 fas fa-tools text-danger"></i>
                            Envoyer en Maintenance
                        </button>
                ...
                <div class="col-md-8 col-12 offset-md-1 display-5">
                    <div class="mt-5 row text-danger">
                    ...
                    <div class="mt-3 row text-danger">
                ...
                <div class="modal-content">
                    ...
                    <form action="/voitures/{{ $voiture->id }}/ajoute-pannes" method="POST">
                        ...
                        <div class="modal-body">
                            <button type="button" class="mb-3 btn btn-primary" @click="incrementNombrePannes"><i class="fas fa-plus-circle"></i> Ajouter Panne</button>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            {{-- Signaler Panne --}}
                            <button type="button" class="btn btn-danger btn-block" data-dismiss="modal" data-toggle="modal" data-target="#panneSignalisation"><i class="mr-2 fas fa-exclamation-triangle text-warning"></i> Ajouter une Panne</button>
                        </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="pasDePannes">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <i class="float-right fas fa-exclamation-triangle fa-2x text-danger"></i>
                        <h5 class="text-center modal-title">Erreur </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                    </div>
        ...
        <div class="modal fade" id="receptionvehiculemaintenance">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="text-center modal-title">Réceptionner Véhicule de Maintenance</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
