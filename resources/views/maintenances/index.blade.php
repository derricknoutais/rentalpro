        ...
        <template>
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-5">
                    <div>
                        <multiselect v-model="filters.contractable_id" :options="contractableOptions" :reduce="optionValue"
                            label="label" track-by="value" placeholder="Contractable" :allow-empty="true"
                            :show-labels="false" class="w-full" />

                        <div>
                            <multiselect v-model="filters.technicien_id" :options="technicienOptions" :reduce="optionValue"
                                label="label" track-by="value" placeholder="Technicien" :allow-empty="true"
                                :show-labels="false" class="w-full" />
                        </div>
                        <div>
                            <multiselect v-model="filters.statut" :options="statusOptions" :reduce="optionValue"
                                label="label" track-by="value" placeholder="Statut" :allow-empty="true"
                                ...
                                <tr v-for="maintenance in filteredMaintenances" :key="maintenance.id"
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-700">
                                        ...
                                        <ul class="mt-1 space-y-1 text-xs text-gray-500 max-h-24 overflow-y-auto pr-1">
                                            ...
                                            <li v-if="!maintenance.pannes || !maintenance.pannes.length"
                                                class="text-gray-400">
                                                Aucune panne</li>
                                        </ul>
                                    </td>
                            ...
                            <div class="space-y-6 px-6 py-6">
                                <div v-if="!isEditing" class="space-y-4">
                                    <div>
                                        ...
                                        <multiselect v-model="form.contractable_id" :options="contractableOptions"
                                            :reduce="optionValue" label="label" track-by="value"
                                            placeholder="-- Choisir --" :allow-empty="true" :show-labels="false"
                                            class="w-full" @input="handleContractableChange" />
                                    </div>

                                    <div class="rounded-xl border border-dashed border-gray-200 p-4"
                                        v-if="form.contractable">
                                        ...
                                        <div v-else>
                                            <div v-if="availablePannes.length"
                                                ...
                                                <label v-for="panne in availablePannes" :key="panne.id"
                                                    ...
                                                    <input type="checkbox" :value="panne.id"
                                                        v-model="selectedPanneIds"
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Titre
                                            (optionnel)</label>
                                    ...
                                    <div>
                                        ...
                                        <multiselect v-model="form.technicien_id" :options="technicienOptions"
                                            :reduce="optionValue" label="label" track-by="value"
                                            placeholder="-- Choisir --" :allow-empty="true" :show-labels="false"
                                            class="w-full" />
                                    </div>
                                ...
                                <div v-else class="rounded-xl border border-gray-100 bg-gray-50 p-4">
                                    ...
                                    <ul class="mt-2 space-y-1 text-sm text-gray-600 max-h-40 overflow-y-auto pr-1">
                                        <li v-for="p in currentMaintenancePannes" :key="p.id"
                                            class="flex gap-2">
                                            <span class="text-gray-400">•</span>
                                            <span>@{{ panneLabel(p) }}</span>
                                        </li>
                                ...
                                <div v-if="isEditing" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <multiselect v-model="form.statut" :options="statusOptions"
                                            :reduce="optionValue" label="label" track-by="value" placeholder="Choisir"
                                            :allow-empty="false" :show-labels="false" :searchable="false"
                                            class="w-full" :option-disabled="statusDisabled" />
                                        <p class="mt-1 text-xs text-gray-500">Clôturez via le bouton « Terminer » pour
                                            passer
                                            en
                                            statut terminé.</p>
                                    </div>
                            ...
                            <div class="space-y-4 px-6 py-6">
                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button @click="submitCompletion"
                                        :disabled="completing || !completionSelection.length"
