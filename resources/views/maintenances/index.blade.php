        ...
        <template>
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-5">
                    <div>
                        <multiselect v-model="filterContractableOption" :options="contractableOptions" label="label"
                            track-by="value" placeholder="Contractable" :allow-empty="true" :show-labels="false"
                            class="w-full" />
                    </div>
                    <div>
                        <multiselect v-model="filterTechnicienOption" :options="technicienOptions" label="label"
                            track-by="value" placeholder="Technicien" :allow-empty="true" :show-labels="false"
                            class="w-full" />
                    </div>
                    <div>
                        <multiselect v-model="filterStatusOption" :options="statusOptions" label="label" track-by="value"
                            placeholder="Statut" :allow-empty="true" :show-labels="false" :searchable="false"
                            class="w-full" />
                    </div>
                        ...
                        <div class="space-y-6 px-6 py-6">
                            <div v-if="!isEditing" class="space-y-4">
                                <div>
                                    ...
                                    <multiselect v-model="formContractableOption" :options="contractableOptions"
                                        label="label" track-by="value" placeholder="-- Choisir --" :allow-empty="true"
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <multiselect v-model="formTechnicienOption" :options="technicienOptions"
                                        label="label" track-by="value" placeholder="-- Choisir --"
                                        :allow-empty="true" :show-labels="false" class="w-full" />
                                </div>
                            </div>
                            ...
                            <div v-if="isEditing" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <multiselect v-model="formStatusOption" :options="statusOptions" label="label"
                                        track-by="value" placeholder="Choisir" :allow-empty="false"
                                        :show-labels="false" :searchable="false" class="w-full"
                                        :option-disabled="statusDisabled" />
