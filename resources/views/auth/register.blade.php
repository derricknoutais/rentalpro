...
@section('content')
    <div class="min-h-screen grid lg:grid-cols-2">
        <div
            class="hidden lg:flex bg-gradient-to-br from-indigo-900 via-slate-900 to-purple-900 flex-col justify-between p-12 text-white">
            <div>
                <div
                ...
                <h1 class="mt-10 text-4xl font-semibold leading-tight">Une seule plateforme pour gérer votre flotte, vos
                    chambres et vos équipes.</h1>
                <p class="mt-6 text-sm leading-relaxed text-indigo-100 max-w-lg">
                    Simplifiez la gestion des contrats, automatisez les rappels et gardez une vision claire de vos
                    paiements.
            ...
            <div class="rounded-3xl bg-white/10 border border-white/15 backdrop-blur-xl p-6 space-y-4">
                ...
                <ul class="space-y-3 text-sm text-indigo-50">
                    <li class="flex items-center gap-3"><span class="h-2 w-2 rounded-full bg-indigo-300"></span> Contrats
                        numériques et signatures intégrées</li>
                    <li class="flex items-center gap-3"><span class="h-2 w-2 rounded-full bg-indigo-300"></span>
                        Planification visuelle des véhicules/chambres</li>
                    <li class="flex items-center gap-3"><span class="h-2 w-2 rounded-full bg-indigo-300"></span> Alertes
                        automatiques (paiements, entretiens, expirations)</li>
                </ul>
            </div>
        </div>
            ...
            <div class="w-full max-w-md space-y-10">
                <div class="text-center space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Complétez les informations ci-dessous pour commencer gratuitement.
                        </p>
                    </div>
                    @if ($errors->any())
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        <label for="email" class="text-sm font-medium text-gray-700">Adresse e-mail
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation" class="text-sm font-medium text-gray-700">Confirmer le mot de
                            passe</label>
                ...
                <p class="text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('login') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Se
                        connecter</a>
                </p>
            </div>
        </div>
