<div class="flex w-full">
    <div class="w-1/3 grid grid-cols-3 flex justify-between mt-3">
        @foreach ($contractables as $contractable)
            <div @if ($contractable->etat === 'disponible') class="border border-black p-5 bg-green-200 mb-3 mr-3 cursor-pointer"
                ...
                @elseif($contractable->etat === 'maintenance')   
                    class="border border-black p-5 bg-black mb-3 mr-3 cursor-pointer text-white" @endif
    ...
    <div
        class="
            @if ($display && $display->etat === 'disponible') bg-green-100
        ...
        @if ($display)
            ...
            @if ($display->etat === 'disponible')
                <a class="btn btn-primary mt-5" href="/contrats/create?contractable_id={{ $display->id }}">Créer un
                    contrat</a>
                ...
                <div>
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                        ...
                        <dd class="max-h-screen mt-10 overflow-y-auto text-sm text-gray-900 sm:mt-10 sm:col-span-2">
                            <ul role="list"
                                class="border border-gray-300 bg-white divide-y divide-gray-200 rounded-md">
                                @foreach ($display->contrats->reverse()->take(5) as $contrat)
        ...
        @else
            <div class="w-full flex flex-col justify-center items-center ">
                ...
                @else
                    <img src="img/logoonly.png" alt="" class="w-1/2">
                    <p class="text-center text-4xl mt-5">
                        Cliquez sur un véhicule pour afficher ses details
                    </p>
                @endif
