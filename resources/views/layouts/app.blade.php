...
<body class="h-full">
    ...
    <div id="app" class="min-h-screen" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
        ...
        <div class="relative z-50 lg:hidden" v-show="isOpen.mobileMenu" role="dialog" aria-modal="true">
            <!--
                ...
                <div class="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                        ...
                        <div class="flex h-16 shrink-0 items-center justify-between">
                            <img class="h-8 w-auto" src="/img/logoonly.png" alt="Your Company">
                        ...
                        <nav class="flex flex-1 flex-col">
                            ...
                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                <li>
                                    <!-- Current: "bg-gray-50 text-blue-600", Default: "text-gray-700 hover:no-underline hover:text-blue-600 hover:bg-gray-50" -->
                                    <a href="#"
                                        class="text-gray-700 hover:no-underline hover:text-blue-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                        <span
                                    ...
                                    <a href="#"
                                        ...
                                        @auth
                                            <a href="{{ route('logout') }}"
                                                ...
                                                <span aria-hidden="true">Déconnecter {{ Auth::user()->name }}</span>
                                            </a>
        ...
        @auth
            ...
            <div class="sticky top-0 z-40 flex items-center gap-x-6 bg-white px-4 py-4 shadow-sm sm:px-6 lg:hidden">
                ...
                <button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden" @click="toggleMobileMenu()">
