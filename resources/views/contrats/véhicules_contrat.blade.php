...
<body>
    ...
    <img src="{{ asset('/img/logoonly.png') }}" style="width: 25rem">
    <p style="margin-top: 0rem">CASE D'ÉCOUTE NGADI, B.P:1268 PORT-GENTIL (GABON) </p>
    <p style="margin-top: 0rem">Téléphone: 011.56.58.17 / 077.15.82.15  </p>
    ...
    <table class="table" style="margin-top: 7rem; font-size:12px;">
        <thead>
            <tr>
                <th>Nb.Jours</th>
                <th>Immatriculation Véhicules</th>
                <th>Prix Unitaire</th>
                <th>Total</th>
            </tr>
        </thead>
