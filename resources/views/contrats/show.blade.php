                    ...
                    <dl class="sm:divide-y sm:divide-gray-200">
                        ...
                        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            @isset($contrat->contractable)
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    <a target="_blank" class="text-blue-600 hover:text-blue-700"
                                        href="/voiture/{{ $contrat->contractable->id }}">{{ $contrat->contractable->immatriculation }}</a>
                                </dd>
                            @endisset
                        </div>
                        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                {{ $contrat->du->format('d/m/Y') . ' - ' . $contrat->au->format('d/m/Y') }}</dd>
                        </div>
                        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <ul role="list" class="border border-gray-200 divide-y divide-gray-200 rounded-md">
                                    ...
                                    <li class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                        <div class="flex items-center flex-1 w-0">
                                            ...
                                            <span class="flex-1 w-0 ml-2 truncate"> coverletter_back_end_developer.pdf
                                            </span>
                                        </div>
                                        <div class="flex-shrink-0 ml-4">
                                            <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">
